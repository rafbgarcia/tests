...
it("Create Group Conversation", () => {
  ...
  cy.get("[id=password]").type("improvement")
  cy.contains("Sign In").click()
  cy.url().should("include", "connect")

  cy.get(".btn-add").click()
  cy.get("[placeholder='Find or start a conversation']").type("Ben Klang")
  cy.wait(300)
  cy.get(".bookmark-selector-list-container .people-bookmark:first").contains("Ben Klang").click()
  cy.get("[placeholder='Find or start a conversation']").clear().type("Jenny Gray")
  cy.wait(300)
